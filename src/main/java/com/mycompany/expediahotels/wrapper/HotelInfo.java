...
public class HotelInfo {
    ...
    public String toString() {
        return "ClassPojo [hotelStreetAddress = " + hotelStreetAddress + ", carPackage = " + carPackage + ", hotelDestination = " + hotelDestination + ", hotelProvince = " + hotelProvince + ", hotelDestinationRegionID = " + hotelDestinationRegionID + ", allInclusive = " + allInclusive + ", hotelId = " + hotelId + ", hotelLongitude = " + hotelLongitude + ", statusCode = " + statusCode + ", movingAverageScore = " + movingAverageScore + ", travelEndDate = " + travelEndDate + ", hotelName = " + hotelName + ", description = " + description + ", promotionTag = " + promotionTag + ", promotionAmount = " + promotionAmount + ", hotelLongDestination = " + hotelLongDestination + ", hotelImageUrl = " + hotelImageUrl + ", hotelStarRating = " + hotelStarRating + ", hotelLatitude = " + hotelLatitude + ", promotionDescription = " + promotionDescription + ", relevanceScore = " + relevanceScore + ", rawAppealScore = " + rawAppealScore + ", hotelLocation = " + hotelLocation + ", hotelCity = " + hotelCity + ", distanceFromUser = " + distanceFromUser + ", statusDescription = " + statusDescription + ", hotelGuestReviewRating = " + hotelGuestReviewRating + ", travelStartDate = " + travelStartDate + ", language = " + language + ", hotelCountryCode = " + hotelCountryCode + ", carPackageScore = " + carPackageScore + "]";
    }
}
